...
const BASE_NONVOTERS = [
  ...
  { name: "0x2c98...5a31", sub: null, vp: 96_000, voted: false },
  { name: "0xab44...1d90", sub: null, vp: 88_000, voted: false },
  { name: "delegateops.eth", sub: "Delegate", vp: 61_500, voted: false },
  { name: "longtail.eth", sub: null, vp: 44_000, voted: false },
  { name: "0x77b1...e904", sub: null, vp: 35_700, voted: false },
  ...
  { name: "silentholder.eth", sub: "Token holder", vp: 16_200, voted: false },
  { name: "0x4d90...8ba1", sub: null, vp: 13_400, voted: false },
  { name: "0xc312...f0a7", sub: null, vp: 10_900, voted: false },
  { name: "0x40d8...ac52", sub: null, vp: 9_800, voted: false },
  ...
  { name: "newcomer.eth", sub: null, vp: 3_100, voted: false },
];
...
const PROPOSAL_DETAILS = {
  "PGF-014": {
    ...
    voters: makeVoters([
      ...
      { name: "delegate-collective.eth", sub: "Delegate", vp: 211_000, choice: "for" },
      { name: "0x88c4...a204", vp: 142_000, choice: "for" },
      { name: "northstar.eth", sub: "Core contributor", vp: 87_500, choice: "against" },
      { name: "yieldfarmer.eth", vp: 52_300, choice: "for" },
      { name: "0x2f91...66bd", vp: 38_900, choice: "for" },
      { name: "tokenwatch.eth", sub: "Token holder", vp: 19_700, choice: "against" },
      { name: "0xd610...3ae8", vp: 11_200, choice: "for" },
      { name: "smallholder.eth", vp: 5_600, choice: "for" },
    ]),
  ...
  "PIP-031": {
    ...
    voters: makeVoters([
      ...
      { name: "0x88c4...a204", vp: 168_000, choice: "for" },
      { name: "northstar.eth", sub: "Core contributor", vp: 121_000, choice: "against" },
      { name: "corevote.eth", sub: "Delegate", vp: 96_500, choice: "for" },
      { name: "0xd610...3ae8", vp: 61_200, choice: "for" },
      { name: "yieldfarmer.eth", vp: 47_800, choice: "against" },
      { name: "0x9b74...10d5", vp: 28_400, choice: "for" },
      { name: "metasignal.eth", sub: "Token holder", vp: 16_900, choice: "for" },
      { name: "0x55e2...cf19", vp: 7_300, choice: "against" },
    ]),
    nonVoters: BASE_NONVOTERS,
    publicComments: [
  ...
  "GRC-009": {
    ...
    voters: makeVoters([
      ...
      { name: "delegate-collective.eth", sub: "Delegate", vp: 184_000, choice: "for" },
      { name: "0x2f91...66bd", vp: 117_000, choice: "for" },
      { name: "northstar.eth", sub: "Core contributor", vp: 87_500, choice: "for" },
      { name: "0xba17...4f60", vp: 53_700, choice: "against" },
      { name: "communitydao.eth", vp: 41_300, choice: "for" },
      { name: "0x6f02...e93c", vp: 22_100, choice: "for" },
      { name: "nodeoperator.eth", sub: "Token holder", vp: 13_800, choice: "against" },
      { name: "0x84c0...11fb", vp: 6_400, choice: "for" },
    ]),
    nonVoters: BASE_NONVOTERS,
    publicComments: [
  ...
  "GOV-005": {
    ...
    voters: makeVoters([
      ...
      { name: "0x88c4...a204", vp: 198_000, choice: "against" },
      { name: "delegate-collective.eth", sub: "Delegate", vp: 156_000, choice: "against" },
      { name: "yieldfarmer.eth", vp: 92_300, choice: "for" },
      { name: "northstar.eth", sub: "Core contributor", vp: 68_700, choice: "against" },
      { name: "0xd610...3ae8", vp: 41_900, choice: "for" },
      { name: "tokenwatch.eth", sub: "Token holder", vp: 24_500, choice: "against" },
      { name: "0x9b74...10d5", vp: 12_100, choice: "for" },
      { name: "smallholder.eth", vp: 4_800, choice: "for" },
    ]),
    nonVoters: BASE_NONVOTERS,
    publicComments: [
  ...
  "PIP-030": {
    ...
    voters: makeVoters([
      ...
      { name: "0xf7a3...c40e", vp: 14_100, choice: "against" },
      { name: "delegate-collective.eth", sub: "Delegate", vp: 201_000, choice: "for" },
      { name: "0x2f91...66bd", vp: 132_000, choice: "for" },
      { name: "yieldfarmer.eth", vp: 89_400, choice: "for" },
      { name: "northstar.eth", sub: "Core contributor", vp: 64_200, choice: "for" },
      { name: "0x88c4...a204", vp: 47_600, choice: "against" },
      { name: "communitydao.eth", vp: 31_900, choice: "for" },
      { name: "0xba17...4f60", vp: 18_300, choice: "for" },
      { name: "nodeoperator.eth", sub: "Token holder", vp: 9_100, choice: "against" },
    ]),
    nonVoters: BASE_NONVOTERS,
    publicComments: [
  ...
  "TRS-008": {
    ...
    voters: makeVoters([
      ...
      { name: "0x2f91...66bd", vp: 174_000, choice: "against" },
      { name: "delegate-collective.eth", sub: "Delegate", vp: 143_000, choice: "for" },
      { name: "northstar.eth", sub: "Core contributor", vp: 99_500, choice: "against" },
      { name: "0x88c4...a204", vp: 76_300, choice: "for" },
      { name: "communitydao.eth", vp: 52_800, choice: "against" },
      { name: "0x9b74...10d5", vp: 34_100, choice: "for" },
      { name: "tokenwatch.eth", sub: "Token holder", vp: 17_600, choice: "against" },
      { name: "smallholder.eth", vp: 6_900, choice: "for" },
    ]),
    nonVoters: BASE_NONVOTERS,
    publicComments: [
  ...
  "PIP-028": {
    ...
    voters: makeVoters([
      ...
      { name: "0x4e91...b7a2", vp: 154_000, choice: "for" },
      { name: "delegate-collective.eth", sub: "Delegate", vp: 217_000, choice: "for" },
      { name: "0x2f91...66bd", vp: 156_000, choice: "for" },
      { name: "yieldfarmer.eth", vp: 108_000, choice: "for" },
      { name: "northstar.eth", sub: "Core contributor", vp: 73_400, choice: "for" },
      { name: "0xd610...3ae8", vp: 49_700, choice: "for" },
      { name: "communitydao.eth", vp: 28_900, choice: "for" },
      { name: "0xba17...4f60", vp: 15_200, choice: "for" },
      { name: "nodeoperator.eth", sub: "Token holder", vp: 7_800, choice: "against" },
    ]),
    nonVoters: BASE_NONVOTERS,
    publicComments: [
